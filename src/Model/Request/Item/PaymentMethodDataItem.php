...
use InworkNet\SDK\Model\Types\PaymentMethodTokenType;
use InworkNet\SDK\Model\Types\PaymentType;
use InworkNet\SDK\Model\Types\PurseType;
...
class PaymentMethodDataItem extends AbstractRequestItem
{
    ...
    /**
     * @var string
     * @see \InworkNet\SDK\Model\PaymentMethods
     */
    private $type;
